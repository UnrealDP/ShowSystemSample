...
#include "ShowSystemEditorMode.generated.h"
 ...
 */
UCLASS()
class UShowSystemEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ShowSystemEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UShowSystemEditorMode();
	virtual ~UShowSystemEditorMode();
