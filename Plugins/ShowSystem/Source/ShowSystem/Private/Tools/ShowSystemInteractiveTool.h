...
#include "ShowSystemInteractiveTool.generated.h"


/**
 * Builder for UShowSystemInteractiveTool
 */
UCLASS()
class SHOWSYSTEM_API UShowSystemInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UShowSystemInteractiveTool
 */
UCLASS(Transient)
class SHOWSYSTEM_API UShowSystemInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UShowSystemInteractiveToolProperties();
...
/**
 * UShowSystemInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class SHOWSYSTEM_API UShowSystemInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UShowSystemInteractiveToolProperties> Properties = nullptr;
