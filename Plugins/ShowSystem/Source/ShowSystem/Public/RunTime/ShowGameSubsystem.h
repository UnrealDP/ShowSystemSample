...
#include "ShowGameSubsystem.generated.h"

/**
 * 
 */
UCLASS()
class SHOWSYSTEM_API UShowGameSubsystem : public UGameInstanceSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	...
	{
		RETURN_QUICK_DECLARE_CYCLE_STAT(UShowGameSubsystem, STATGROUP_Tickables);
	}
